          ...
          >
            {fields.length === 0 && (
              <Box component="span" sx={{ p: 2, border: "1px dashed grey" }}>
                <h1>
                  To add fields please drag and drop or click on the button that
                  inside the Add Fields list
                </h1>
              </Box>
            )}
            <div
              ...
              <div className="text-center justify-center m-2">
                {addFieldList.map((item, index) => (
                  <div
                    ...
                    draggable
                    onDragStart={(e) => handleOnDrag(e, item.type, item.title)}
                    name={item.title}
                  >
                ...
                <Accordion style={{ width: "100%", margin: "1px" }}>
                  ...
                  <AccordionDetails>
                    ...
                    >
                      ...
                      <Select
                        style={{ width: "60%" }}
                        onChange={(e) => setSelectedFieldAlgin(e.target.value)}
                      >
                      ...
                      {defaultChoices.map((item, i) => (
                        <>
                          <input
                            ...
                            name={item.title}
                            onChange={(e) =>
                              handelChoices((item) => [...item, e.target.value])
                            }
                          />
